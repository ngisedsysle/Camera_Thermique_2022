/****************************************************************************
 * boards/arm/stm32h7/stm32h743vit6-ct2022/src/stm32_spi.c
 *
 ...
 *
 * Description:
 *   Called to configure SPI chip select GPIO pins for the STM32H743VIT6-CT2022
 *    board.
 *
 ****************************************************************************/
 ...
 */
  ...
  /* Configure the FT80x CS pin as an input */
  stm32_configgpio(GPIO_LEPTON_CS);
#endif
}
                      ...
                      bool selected)
{
  ...
  stm32_gpiowrite(GPIO_LEPTON_CS, !selected);
#endif
}
