/****************************************************************************
 * boards/arm/stm32h7/stm32h747i-disco/src/stm32_ft80x.c
 *
...
static struct stm32h7_ft80xlower_s g_ft80xlower =
{
  .config =
  {
    .init_frequency = CONFIG_STM32H7_FT80X_INITFREQUENCY,
    .op_frequency   = CONFIG_STM32H7_FT80X_OPFREQUENCY
,
...
static int ft80x_attach(const struct ft80x_config_s *lower, xcpt_t isr,
                        void *arg)
{
  struct stm32h7_ft80xlower_s *priv =
    (struct stm32h7_ft80xlower_s *)lower;
                          ...
                          bool pwrdown)
{
  ...
  stm32_gpiowrite(GPIO_FT80X_PD, !pwrdown);
}
...
int stm32_ft80x_setup(void)
{
  ...
  stm32_configgpio(GPIO_FT80X_PD);
...
#endif /* CONFIG_STM32H7_FT80X_SPI1 || CONFIG_STM32H7_FT80X_SPI2 */
