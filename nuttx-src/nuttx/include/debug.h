...
#ifdef CONFIG_DEBUG_CAMERA_ERROR
#  define camerr       _err
#else
#  define camerr      _none
#endif

#ifdef CONFIG_DEBUG_CAMERA_WARN
#  define camwarn     _warn
#else
#  define camwarn     _none
#endif

#ifdef CONFIG_DEBUG_CAMERA_INFO
#  define caminfo     _info
#else
#  define caminfo     _none
#endif
...
#ifdef CONFIG_DEBUG_CAM
#  define camerrdumpbuffer(m,b,n)  errdumpbuffer(m,b,n)
#  define caminfodumpbuffer(m,b,n) infodumpbuffer(m,b,n)
#else
#  define camerrdumpbuffer(m,b,n)
#  define caminfodumpbuffer(m,b,n)
#endif
